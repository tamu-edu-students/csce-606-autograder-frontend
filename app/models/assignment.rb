class Assignment < ApplicationRecord
    # after_save is not needed anymore as we are manually calling this from the controller in the update action.
    # Therefore, removed after_save :push_changes_to_github
