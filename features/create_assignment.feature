Feature: Create a new assignment
    ...
    Scenario: Create a new assignment as an instructor or ta-read-write
        ...
        And I should see the "csce-120-hw1" repository in the CSCE 120 GitHub
            organization
        And I should see a local clone of the "csce-120-hw1" repository
        And I should see the "autograder_core_deploy_key" in "/secrets" of the
            "csce-120-hw1" repository
        And I should see the deploy_key in "/secrets" of the "csce-120-hw1"
            repository
